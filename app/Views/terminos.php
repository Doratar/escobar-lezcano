<div class="container">
    ...
    El uso de este sitio web después de los cambios significa que usted acepta las condiciones de uso revisadas. Si, después de leer la versión revisada, no está de acuerdo con sus términos, por favor, termine su acceso.</p>

    <h5>Sección 1 - Usuario</h5>
    ...
    <h5>Sección 2 - Adhesión junto con la política de privacidad</h5>

    <p>El uso de este sitio web implica la adhesión a estas Condiciones de Uso y a la versión más actualizada de la Política de Privacidad de Kicks Up.</p>

    <h5>Sección 3 - Condiciones de acceso</h5>

    <p>En general, el acceso al sitio web de Kicks Up es gratuito y no requiere registro previo.Sin embargo, para hacer uso de algunas funcionalidades, el usuario puede necesitar registrarse, creando una cuenta de usuario con un nombre de usuario y una contraseña de acceso.
    ...
    Algunas partes de este sitio web ofrecen al usuario la opción de publicar comentarios en determinadas áreas. Kicks Up no consiente la publicación de contenidos de carácter discriminatorio, ofensivo o ilícito, o que infrinjan los derechos de autor o cualquier otro derecho de terceros.

    La publicación de cualquier contenido por parte del usuario de este sitio web, incluidos los mensajes y comentarios, implica una licencia no exclusiva, irrevocable e irreversible para su uso, reproducción y publicación por parte de Kicks Up en su sitio web, plataformas de internet y aplicaciones, o incluso en otras plataformas, sin ninguna restricción o limitación.</p>

    <h5>Sección 4 - Cookies</h5>
    ...
    <h5>Sección 5 - Propiedad intelectual</h5>

    <p>Todos los elementos de Kicks Up son propiedad intelectual de la misma o de sus licenciantes. Estos términos o el uso del sitio web no le otorgan ninguna licencia o derecho de uso de los derechos de propiedad intelectual de Kicks Up o de cualquier tercero.</p>

    <h5>Sección 6 - Enlaces a sitios web de terceros</h5>
    ...
    <h5>Sección 7 - Plazos y modificaciones</h5>

    <p>El funcionamiento de este sitio web es por tiempo indefinido.

    La totalidad del sitio web o cada una de sus secciones podrá ser cerrada, suspendida o interrumpida unilateralmente por Kicks Up, en cualquier momento y sin previo aviso.</p>

    <h5>Sección 8 - Datos personales</h5>

    <p>Durante el uso de este sitio web, ciertos datos personales serán recogidos y procesados por Kicks Up y/o los Socios. Las normas relativas al tratamiento de los datos personales de Kicks Up están estipuladas en la Política de Privacidad.</p>

    <h5>Sección 9 - Contacto</h5>

    <p>Si tiene alguna pregunta sobre las condiciones de uso, por favor póngase en contacto con nosotros por correo electrónico contacto@Kicksup.com o sino <a href="contacto">Contacto</a></p>
</div>