...
<div class="text-center">
    <?php if (empty($cart)): ?>
        ...
        <a class="btn btn-warning text-dark mt-2" href="<?= base_url('/admin/productos') ?>">
                ...
                <tr class="table-light">
                    ...
                    <td colspan="2" class="text-end">
                        <input type="button" class="btn btn-primary btn-lg" value="Borrar Carrito"
                               onclick="window.location='<?= base_url('borrar') ?>'">
                        <input type="button" class="btn btn-secondary btn-lg" value="Comprar"
                               onclick="window.location='<?= base_url('carrito-comprar') ?>'">
                    </td>
                </tr>
            </tbody>
        </table>
